...
import br.dcc.ufrj.asranksavvrp.ant.ModifiedMMASAnt;

public class ModifiedMMASWorld extends World {
	...
	public ModifiedMMASWorld() {
		super();
	}

	public ModifiedMMASWorld(long seed) {
		super(seed);
	}
	...
	public void createAnts(int total) {
		...
		for (int i = 0; i < total; i++) {
			this.ants[i] = new ModifiedMMASAnt(i, this.getFirstDepot(), this.getCapacity(), this.getDimension());
		}
