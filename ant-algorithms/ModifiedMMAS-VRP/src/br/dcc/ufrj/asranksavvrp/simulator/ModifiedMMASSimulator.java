...
import br.dcc.ufrj.asranksavvrp.world.ModifiedMMASWorld;

public class ModifiedMMASSimulator extends Simulator{
	...
	private void printIntance(ModifiedMMASWorld world) {
	...
	public static void main(String[] args) throws Exception {
		ModifiedMMASSimulator simulator = new ModifiedMMASSimulator();
		...
		ModifiedMMASWorld world = new ModifiedMMASWorld(0);
